...
def ejecutar_pipeline_kmeans(df: pd.DataFrame, n_clusters: int = 4) -> dict:
    ...
    """
    # Filtramos municipios muy pequeños
    ...
    # Unimos los identificadores y las tasas antes de meter el cluster
    ...
    # ConNTEXTO DEL PERFIL Y ETIQUETADO INTELIGENTE (Z-SCORES)
    ...
    # PERFILES PROMEDIO PARA mapa de calor
